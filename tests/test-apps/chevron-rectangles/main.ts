...
for (let i = 0; i < 10; i++) {
    let rectConf: soda.ChevronRectangleConfig<soda.OrientedAnnotation, soda.TrackChart<soda.TrackChartRenderParams>> = {
    ...
    soda.chevronRectangleGlyph(chart, ann.slice(i, i+1), rectConf);
}
