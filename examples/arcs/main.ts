...
let axis = new soda.AxisChart({selector: '#axis-chart', height: 50});
let chart = new soda.TrackChart({selector: '#track-chart', binHeight: 20});
...
let arcConf: soda.ArcConfig<soda.Annotation, soda.TrackChart<soda.TrackChartRenderParams>> = {
    selector: 'ann',
